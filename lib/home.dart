...
class HomePage extends StatelessWidget{
  ...
  _customCard({String imageUrl, String item, String duration,double width}){
    return SizedBox(
        height: 168,
       width: width,
        child: Card(
    ...
    child: Padding( padding: EdgeInsets.all(8),
      child: Column(
        ...
        children: <Widget>[
          Image.asset("assets/home_images/" + imageUrl,width: 100,height: 100,),
          Align(
